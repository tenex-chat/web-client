...
export class ModelDiscovery {
  ...
  private async fetchFromProvider(provider: ProviderType, apiKey: string): Promise<Model[]> {
    switch (provider) {
      case 'openai':
  ...
  private async fetchAnthropicModels(): Promise<Model[]> {
    ...
    return [
      { id: 'claude-3-opus-20240229', name: 'Claude 3 Opus', category: 'Advanced' },
      { id: 'claude-3-5-sonnet-20241022', name: 'Claude 3.5 Sonnet', category: 'Balanced' },
      { id: 'claude-3-haiku-20240307', name: 'Claude 3 Haiku', category: 'Fast' },
    ]
  }
  ...
  private async fetchGoogleModels(): Promise<Model[]> {
    ...
    return [
      ...
      { id: 'gemini-1.5-pro-002', name: 'Gemini 1.5 Pro 002', category: 'Advanced' },
      { id: 'gemini-1.5-flash', name: 'Gemini 1.5 Flash', category: 'Fast' },
      { id: 'gemini-1.5-flash-002', name: 'Gemini 1.5 Flash 002', category: 'Fast' },
    ]
  }
