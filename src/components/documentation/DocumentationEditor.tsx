    ...
    extensions: [
      StarterKit.configure({
        ...
        codeBlock: {
          HTMLAttributes: {
            class:
              "bg-zinc-100 dark:bg-zinc-900 rounded-md p-4 font-mono text-sm my-4",
          },
        },
        code: {
          HTMLAttributes: {
            class:
              "bg-zinc-100 dark:bg-zinc-900 px-1.5 py-0.5 rounded font-mono text-sm",
          },
        },
        blockquote: {
          HTMLAttributes: {
      ...
      Link.configure({
        ...
        HTMLAttributes: {
          class:
            "text-blue-600 dark:text-blue-400 underline underline-offset-4 hover:text-blue-800 dark:hover:text-blue-300",
        },
      }),
      Placeholder.configure({
        placeholder,
        emptyNodeClass:
          "first:before:text-muted-foreground/40 first:before:float-left first:before:content-[attr(data-placeholder)] first:before:pointer-events-none first:before:h-0",
      }),
    ],
    content,
    onUpdate: ({ editor }) => {
