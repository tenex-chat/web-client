import { NDKArticle, NDKEvent, NDKProject, NDKTask } from "@nostr-dev-kit/ndk-hooks";
...
interface LayoutDrawersProps {
	...
	onThreadStart: (project: NDKProject, threadTitle: string, selectedAgents: ProjectAgent[]) => void;
