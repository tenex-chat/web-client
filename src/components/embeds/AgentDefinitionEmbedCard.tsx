...
export function AgentDefinitionEmbedCard({
  event,
  compact,
  className,
  onClick,
}: AgentDefinitionEmbedCardProps) {
                ...
                <div>
                  ...
                  <DialogDescription>
                    {agent.role && (
                      <Badge
                        variant="secondary"
                        className={cn("mt-1", getRoleColor(agent.role))}
                      >
                        {agent.role}
                      </Badge>
                    )}
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-base flex items-center gap-2">
                  ...
                  {agent.role && (
                    <Badge
                      variant="outline"
                      className={cn("text-xs", getRoleColor(agent.role))}
                    >
                      {agent.role}
                    </Badge>
                  )}
