...
const predefinedPhases = {
  ...
  plan: { bg: 'bg-purple-500/90', text: 'text-white', border: 'border-purple-600' },
  execute: { bg: 'bg-green-500/90', text: 'text-white', border: 'border-green-600' },
  review: { bg: 'bg-orange-500/90', text: 'text-white', border: 'border-orange-600' },
  chores: { bg: 'bg-gray-500/90', text: 'text-white', border: 'border-gray-600' },
} as const
...
export function getPhaseColors(phase: string | null | undefined) {
  if (!phase) {
    return { bg: 'bg-gray-400/90', text: 'text-white', border: 'border-gray-500' }
  }
...
export function getPhaseIndicatorColor(phase: string | null | undefined): string {
