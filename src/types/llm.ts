export type LLMProvider = 'openai' | 'openrouter' | 'anthropic' | 'google' | 'groq' | 'deepseek' | 'ollama';
...
export const STATIC_MODELS: Record<LLMProvider, LLMModelOption[]> = {
  ...
  anthropic: [
    { id: 'claude-3-5-sonnet-20241022', name: 'Claude 3.5 Sonnet', provider: 'anthropic', supportsCaching: true, contextLength: 200000 },
    { id: 'claude-3-5-haiku-20241022', name: 'Claude 3.5 Haiku', provider: 'anthropic', supportsCaching: true, contextLength: 200000 },
    { id: 'claude-3-opus-20240229', name: 'Claude 3 Opus', provider: 'anthropic', supportsCaching: true, contextLength: 200000 },
    { id: 'claude-3-sonnet-20240229', name: 'Claude 3 Sonnet', provider: 'anthropic', supportsCaching: true, contextLength: 200000 },
    { id: 'claude-3-haiku-20240307', name: 'Claude 3 Haiku', provider: 'anthropic', supportsCaching: true, contextLength: 200000 }
  ],
  google: [
  ...
  groq: [
    { id: 'llama-3.1-70b-versatile', name: 'Llama 3.1 70B Versatile', provider: 'groq', contextLength: 32768 },
    { id: 'llama-3.1-8b-instant', name: 'Llama 3.1 8B Instant', provider: 'groq', contextLength: 32768 },
  ...
  deepseek: [
    ...
    { id: 'deepseek-coder', name: 'DeepSeek Coder', provider: 'deepseek', contextLength: 32768 }
  ],
...
export const SPEECH_MODELS: Record<SpeechProvider, Array<{ id: string; name: string }>> = {
  ...
  openrouter: [
    { id: 'openai/whisper-1', name: 'Whisper (via OpenRouter)' }
  ]
};