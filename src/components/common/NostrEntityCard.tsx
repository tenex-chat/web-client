...
import { NDKArticle, NDKTask } from "@nostr-dev-kit/ndk";
import { Card } from "../ui/card";
import { Drawer, DrawerContent, DrawerHeader, DrawerTitle } from "../ui/drawer";
import { FileText, ExternalLink } from "lucide-react";
import type { NostrEntity } from "../../utils/nostrEntityParser";
import { getEntityDisplayInfo, isAddressPointer, isTaskEntity } from "../../utils/nostrEntityParser";
...
export function NostrEntityCard({ entity, className, onTaskClick }: NostrEntityCardProps) {
	...
	const isArticle = entity.type === "naddr" && isAddressPointer(entity.data) && entity.data.kind === 30023;
	...
	if (isArticle && event) {
		...
		articleTitle =
			article.title || (isAddressPointer(entity.data) ? `${entity.data.identifier?.toUpperCase()} Specification` : "Specification");
