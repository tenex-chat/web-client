 ...
 */
export function getAvatarBackgroundColor(pubkey: string | undefined, opacity: number = 0.1): string {
  if (!pubkey) {
 ...
 */
export function getAvatarGradientBackground(pubkey: string | undefined): string {
  if (!pubkey) {
