import { NDKProject, NDKTask } from "@nostr-dev-kit/ndk-hooks";
					...
					<div className="space-y-0.5 sm:space-y-1 px-1 sm:px-2 pt-1 sm:pt-2">
						{sortedProjects.map((project) => {
							...
							return (
								<div
									key={project.tagId()}
									className="group flex items-center p-2.5 sm:p-3 mx-0.5 sm:mx-1 rounded-lg sm:rounded-xl hover:bg-white/80 cursor-pointer transition-all duration-200 ease-out hover:shadow-sm active:scale-[0.98] border border-transparent hover:border-slate-100"
